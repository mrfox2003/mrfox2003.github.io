              ...
              >
                <CardHeader className="space-y-3 sm:space-y-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-4">
                    ...
                    <Badge className={`${getStatusColor(project.status)} text-xs sm:text-sm whitespace-nowrap`}>
                      {project.status}
                    </Badge>
                  </div>
                ...
                <CardContent className="space-y-4 sm:space-y-6">
                  {/* Features List */}
                  <div>
                    <h4 className="font-medium mb-2 sm:mb-3 text-primary text-sm sm:text-base">Key Features:</h4>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-smooth text-xs sm:text-sm"
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-muted-foreground hover:text-primary transition-smooth w-auto sm:w-auto px-2 sm:px-4"
                    >
        ...
        <DialogContent className="max-w-lg mx-4 sm:mx-auto">
          {selectedProject && (
            <div>
              ...
              <p className="mb-4 text-sm sm:text-base text-muted-foreground">{selectedProject.description}</p>
              <div className="mb-4">
